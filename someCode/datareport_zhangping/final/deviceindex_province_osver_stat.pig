...
dlilog = load '/dp/dailylaunch/$yearmonth[0-2][1-2]/compacted/*' using dli_loader;
...
set job.name 'proAccessOsverStat_$yearmonth' ;
store C into '/tmp/device_index/pro_access_osver_stat_$yearmonth' using PigStorage('\t');
