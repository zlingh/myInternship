 ...
 *  load logs *
 *************/
llog = load 'device_index_rawlog/dataok' as(os:chararray, os_version:chararray, model:chararray, cpu:chararray, resolution:chararray, jailbreak:int, modelNum:int, launchNum:int);
